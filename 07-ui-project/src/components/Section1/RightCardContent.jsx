...
const RightCardContent = (props) => {
    return (
        <div className='absolute top-0 right-0 h-full w-full p-8 flex flex-col justify-between'>
            ...
            <div>
                <p className='text-xl leading-relaxed text-white mb-14'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Dolore cumque doloremque voluptas illo explicabo corrupti.</p>
